  ...
  return (
    <>
        ...
        <div className="max-w-[1070px] mx-auto flex flex-col gap-20 mt-[65px] px-4">
          ...
          <div className="flex flex-col gap-[10px]">
            ...
            <div className="max-h-[315px] columns-2 gap-8 overflow-hidden">
              <p className="text-[#09121F] text-base"></p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#E9EBF0] rounded-[63px] px-4 py-[60px] md:py-[125px]">
        <div className="max-w-[1070px] mx-auto flex flex-col md:flex-row items-start gap-10 md:gap-[88px]">
          <Image
            src="/assets/images/about-hero-img.png"
            alt="about img"
            width={476}
            height={490}
            className="w-full md:w-[476px] h-auto md:h-[490px] object-cover rounded-[43px]"
          />
