  ...
  return (
    <>
      <section className="w-full bg-[#E9EBF0] pb-[114px] rounded-b-[63px]">
        <div className="max-w-[603px] pt-[156px] mx-auto z-20 text-center px-4">
          <h1 className="text-[40px] md:text-[57px] font-bold text-[#09121F]">
            Welcome to - <br /> Architex.land
          </h1>
          <p className="text-base text-[#09121F] max-w-[300px] mx-auto mt-4">
            Your ultimate resource for architects, studios, and landowners.
          </p>
        </div>

        <div className="max-w-[1070px] mx-auto flex flex-col gap-20 mt-[65px] px-4">
          <Image
            src="/assets/images/about-hero-img.png"
            alt="about img"
            width={1070}
            height={604}
            className="h-[280px] sm:h-[400px] md:h-[604px] rounded-[43px]"
          />

          <div className="flex flex-col gap-[10px]">
            <h4 className="text-[#09121F] text-[45px] font-bold">About Us</h4>
            <div className="max-h-auto md:max-h-[315px] columns-1 md:columns-2 gap-8 overflow-hidden">
      ...
      <section className="w-full pt-20 py-[95px]">
        <div className="flex flex-col gap-10 max-w-[1070px] mx-auto px-4">
          <h4 className="text-[45px] text-white font-bold">Our Team</h4>

          <div className="bg-[#E9EBF0] rounded-[21px] p-5">
            <div className="flex flex-col sm:flex-row items-center gap-10 md:gap-[70px]">
              {ourMemberConstants.map((member, i) => (
                <div className="flex flex-col gap-[22px]" key={i}>
                  ...
                  <div className="flex flex-col items-center gap-[15px]">
                    <h5 className="font-bold text-[#09121F] text-[25px] text-center">
                      {member.fullName}
                    </h5>
      ...
      <section className="w-full bg-[#E9EBF0] rounded-[63px] px-4 py-[60px] md:py-[125px]">
        <div className="max-w-[1070px] mx-auto flex flex-col xl:flex-row items-center xl:items-start gap-10 md:gap-[88px]">
          <Image
            src="/assets/images/about-hero-img.png"
            alt="about img"
            width={476}
            height={490}
            className="w-full md:w-[476px] h-[342px] md:h-[490px] object-cover rounded-[43px] order-2 xl:order-1"
          />

          <div className="flex flex-col gap-3 order-1 xl:order-2">
            <h3 className="text-[32px] md:text-[57px] font-bold text-[#09121F]">
              Welcome to - <br /> Architex.land
            </h3>
            <p className="text-[#09121F] text-base">
